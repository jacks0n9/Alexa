                                    ...
                                    int          Length)
{
    ...
    if (Length < (int)(sizeof(ACL_HEADER)+sizeof(L2CAP_HEADER))) {
        return FALSE;
    }
                                  ...
                                  int           Length)
{
    ...
    if (Length < (int)(sizeof(ACL_HEADER)+sizeof(L2CAP_HEADER)+sizeof(L2CAP_CONTROL)-6)) {
        return FALSE;
    }
    ...
    if (Length >= (int)(sizeof(ACL_HEADER)+sizeof(L2CAP_HEADER)+sizeof(L2CAP_CONTROL)-sizeof(A_UINT16))) {
