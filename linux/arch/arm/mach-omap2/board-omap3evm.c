...
static int __init omap3_evm_i2c_init(void)
{
	...
	/* Bus 2 is used for Camera/Sensor interface AND 325x codec*/
	omap_register_i2c_bus(2, 400, omap3evm_i2c_boardinfo2,
			ARRAY_SIZE(omap3evm_i2c_boardinfo2));
...
static struct platform_device omap3_evm_aic325x = {                                                                                                            
        .name           = "tlv320aic325x",                                                                                                            
        .id             = -1,                                                                                                                                
}; 
