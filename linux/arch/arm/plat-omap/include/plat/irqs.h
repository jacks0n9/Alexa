...
/* External TPS65910 can handle interrupts on 2430 and 34xx boards */
#define	TPS65910_IRQ_BASE	(MSI_IRQ_END)
#ifdef	CONFIG_MFD_TPS65910
#define	TPS65910_NR_IRQS	10
#else
#define	TPS65910_NR_IRQS	0
#endif
#define TPS65910_IRQ_END		(TPS65910_IRQ_BASE + TPS65910_NR_IRQS)

/* GPMC related */
#define OMAP_GPMC_IRQ_BASE	(TPS65910_IRQ_END)
