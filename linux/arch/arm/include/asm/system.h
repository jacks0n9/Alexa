...
extern unsigned char system_wifi_mac_addr[MAC_ADDR_SIZE];
extern unsigned char system_bt_mac_addr[MAC_ADDR_SIZE];
...
extern unsigned char system_idme[IDME_SIZE];
extern unsigned int system_idme_size;
#endif
