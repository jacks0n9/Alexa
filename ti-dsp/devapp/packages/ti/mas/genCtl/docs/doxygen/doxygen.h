...
/**
 * @mainpage GENCTL Package
 *
 * @section introduction Introduction
 *
 * GENCTL is a "Codec" implementation of ECO class of Codec Engine Extension (VISA Extension).
 * This provides capability into CodecEngine to do Control calls in parallel to the process call 
 * for any ECO/DEVNODE class of algorithms.
 *
 * @section modules Modules
 *
 * The GENCTL interfaces:
 *   - @ref GENCTL 
 *  
 *
 */
