...
/**
 * @mainpage AEU Package
 *
 *
 * @section introduction Introduction
 *
 * The purpose of AEU or Audio Enhancement Unit is to provide a xDAIS container for 
 * various Audio Processing Algorithms like Active Level Control, Simple VAD etc. into one place.
 * There can be many algos in one AEU instance.
 *
 * @section modules Modules
 *
 * The AEU Message/Control interface:
 *   - @ref ti_mas_aeu_AEU 
 *
 */
