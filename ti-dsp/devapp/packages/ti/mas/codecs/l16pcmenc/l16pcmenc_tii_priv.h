 ...
 ******************************************************************************
 * FILE NAME   : l16pcmenc_tii_priv.h
 *
...
#ifndef L16PCMENC_TII_PRIV_
#define L16PCMENC_TII_PRIV_
...
#define L16PCMENC_BYTESWAP(a) ((((a) & 0xFF) << 8) | (((a) >> 8) & 0xFF))

#endif /* L16PCMENC_TII_PRIV_ */
