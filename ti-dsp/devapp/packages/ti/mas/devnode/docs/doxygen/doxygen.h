...
/**
 * @mainpage DEVNODE Package
 *
 * @ref ReleaseNotes
 *
 * @section introduction Introduction
 *
 * DEVNODE is a Codec Engine Extension (VISA Extension). This provides capability into CodecEngine
* to run Device Drivers and provides Issue/Reclaim type Interface.
 *
 * @section modules Modules
 *
 * The DEVNODE interfaces:
 *   - @ref ti_mas_devnode_IDEVNODE 
 *  
 *
 */
