...
public class ti_mas_vpe
{
    ...
    void Version$$CONSTS()
    {
        ...
        om.bind("ti.mas.vpe.Version.MINOR", 2L);
        om.bind("ti.mas.vpe.Version.XVERTICAL", 0L);
        om.bind("ti.mas.vpe.Version.PATCH", 1L);
        om.bind("ti.mas.vpe.Version.WIDTH", 4L);
        om.bind("ti.mas.vpe.Version.PKGSTD", 1L);
    }
    ...
    void Version$$TYPES()
    {
        ...
        po.init("ti.mas.vpe.Version.Module", om.findStrict("ti.mas.swtools.IVersion.Module", "ti.mas.vpe"));
                po.addFld("$hostonly", $$T_Num, 1, "r");
                po.addFld("MAJOR", Proto.Elm.newCNum("(xdc_UInt16)"), 3L, "rh");
                po.addFld("MINOR", Proto.Elm.newCNum("(xdc_UInt16)"), 2L, "rh");
                ...
                po.addFxn("getString", (Proto.Fxn)om.findStrict("ti.mas.swtools.IVersion$$getString", "ti.mas.vpe"), $$UNDEF);
    }
    ...
    void $$SINGLETONS()
    {
        ...
        pkgV.bind("$vers", Global.newArray("2, 0, 3, 0"));
