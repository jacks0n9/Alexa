...
export GCARMV7ACGTOOL := /apps/mentor/sourceryg++lite/arm-2009q1-203
...
export PATH := $(PATH):$(XDC_INSTALL_DIR):$(DOXYGEN_INSTALL_DIR):/apps/installJammer/current:/apps/free/php/5.3.3b/bin
