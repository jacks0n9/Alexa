...
/* Default compiler option for C55x - Debug */
   ...
   var commonC64xCopts = " -c -k -q --mem_model:data=far -al -pds1111 -pds827 -pds824 -pds837 -pds1037 -pds195 -pdsw225 -pdsw994 -pdsw262 -pds77 -pden -pds232 --consultant -mw -g -mi10000 -as -ss";
...
function parseArgs(arguments)
{
 ...
 for each(var xtarget in xtargs)
 {
	...
	{
	   	print("IMPORTANT: "+ xtarget+" target is not supported in this build enviornment. Please correct the build enviornment to support this target\n");
    }
 }
  ...
  for(var k=0;k<targs.length;k++)
  {
    for(n in exeTarget)
    {
       ...
       {   
          ...
          {
            exeTarget[n].base_directory = "lnkr/"+targParams.target; 
          }  
             ...
             if(readLine.match(".cmd"))
             {
                ...
                /* Remove inverted commas(") */
                 ...
                 while((readLinelnk=lnkFilemake.readLine()) != null)
                 {
				   ...
				   if(!readLinelnk.toString().match(".a"+targs[k].suffix))
				   {
    ...
    if (xmltree["Product"].xml_packaging_version == "1.0.0.0") {
     ...
     if(xdc.findFile("./docs/bundle/doxygen/release.h.xdt"))
     {
      ...
      if (install == true) {
        ...
        var WinInstallDir = " -DWinInstallDir C:/Program Files/Texas Instruments/" + getZipFilename(archivefilename,true);
    ...
    if(makefile==undefined)
    {
        ...
        if(bundlename != undefined)
        {
            ...
            if(ext == "")
            {
	          ...
	          var archivefilename = bundlename+"_"+ext;
            component_install_dir = "C:/Program Files/Texas Instruments/"+getZipFilename(archivefilename,true)
  ...
  if(setPostBuildStep == true)
	{
         ...
         var Command = eclipseCmd+" ";
              ...
              Command += " -ccs.buildLocation \'$${project_loc}/"+_toRelative(targetpath,basepath.getCanonicalPath())+"'";
        Pkg.makeEpilogue += "\nall: "+ bundlename.toString().toUpperCase();
				Pkg.makeEpilogue += "\n"+bundlename.toString().toUpperCase()+ ": .xdcenv.mak Package.bld Package.mak" ;
				Pkg.makeEpilogue += "\n\t"+Command;
		  ...
		  for each(var target in targs)
		  {
            ...
            if(targParams.target.toString().match(project["params"].target))
			{
			  switch(target)
			  {
				   ...
				   var cflags = "-mv64plus -k -mw --strip_coff_underscore";   
				   var suffix = "LE_ELF";     
				   break;
           ...
           case C674:
				   ...
				   var device ="com.ti.ccstudio.deviceModel.C6000.CustomC6000Device";   
				   var outputFormat = "elf";   
				   var cflags = "-mv6740 -k -mw --strip_coff_underscore";   
				   var suffix = "LE_ELF";     
				   break;
				   ...
				   var device = "com.ti.ccstudio.deviceModel.C6000.CustomC6000Device";   
				   var outputFormat = "elf";   
				   var cflags = "-mv6600 -k  -mw --strip_coff_underscore";  
				   var suffix = "LE_ELF";     				         
				   break;   
       ...
       {  
         ...
         Command += " -ccs.definePathVariable "+element.macro+" "+incpath;  
		  ...
		  if(setPostBuildStep == true)
		  {
            ...
            Command += " -ccs.setPostBuildStep '$${C6000_CG_ROOT}/bin/ar6x rq "+relative+"/"+libName+".a"+target.suffix+" "+objfile+"' @configurations Release";
	      }
