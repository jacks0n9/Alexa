...
#define yyparse         parser_expr_parse
#define yylex           parser_expr_lex
#define yyerror         parser_expr_error
#define yylval          parser_expr_lval
#define yychar          parser_expr_char
#define yydebug         parser_expr_debug
#define yynerrs         parser_expr_nerrs
#define yylloc          parser_expr_lloc

/* Copy the first part of user declarations.  */


/* Line 189 of yacc.c  */
#line 81 "parser-expr-grammar.c"
...
/* Line 209 of yacc.c  */
#line 113 "parser-expr-grammar.c"
