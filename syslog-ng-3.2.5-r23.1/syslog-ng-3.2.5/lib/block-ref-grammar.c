...
#define yyparse         block_ref_parse
#define yylex           block_ref_lex
#define yyerror         block_ref_error
#define yylval          block_ref_lval
#define yychar          block_ref_char
#define yydebug         block_ref_debug
#define yynerrs         block_ref_nerrs
#define yylloc          block_ref_lloc

/* Copy the first part of user declarations.  */


/* Line 189 of yacc.c  */
#line 81 "block-ref-grammar.c"
...
/* Line 264 of yacc.c  */
#line 398 "block-ref-grammar.c"
/* Unqualified %code blocks.  */

/* Line 265 of yacc.c  */
#line 46 "block-ref-grammar.y"
...
{
     128,     0,    -1,    -1,   129,   125,   130,   126,    -1,   131,
     130,    -1,    -1,   116,   125,   133,   126,    -1,   116,    -1,
     119,    -1,   132,    -1,   117,    -1,   118,    -1
};

/* YYRLINE[YYN] -- source line where rule number YYN was defined.  */
static const yytype_uint16 yyrline[] =
{
       0,   280,   280,   280,   287,   288,   292,   297,   298,   313,
     314,   315
};
#endif
...
static const char *const yytname[] =
{
  ...
  "$accept", "start", "$@1", "block_args", "block_arg", "string",
  "string_or_number", 0
};
#endif
...
{
       0,   127,   129,   128,   130,   130,   131,   132,   132,   133,
     133,   133
};
...
{
    -121,     4,  -120,  -121,  -110,  -118,  -117,  -110,  -116,  -121,
    -121,  -121,  -121,  -121,  -121,  -121,  -115,  -121
};

/* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] =
{
    -121,  -121,  -121,     1,  -121,  -121,  -121
};
...
{
      11,    12,    13,    14,     3,     4,     5,     8,    10,     9,
       0,    17
};

static const yytype_int8 yycheck[] =
{
     116,   117,   118,   119,     0,   125,   116,   125,     7,   126,
      -1,   126
};
...
{
       0,   128,   129,     0,   125,   116,   130,   131,   125,   126,
     130,   116,   117,   118,   119,   132,   133,   126
};
...
/*ARGSUSED*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yy_symbol_value_print (FILE *yyoutput, int yytype, YYSTYPE const * const yyvaluep, YYLTYPE const * const yylocationp, CfgLexer *lexer, CfgArgs **result)
#else
static void
...
`--------------------------------*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yy_symbol_print (FILE *yyoutput, int yytype, YYSTYPE const * const yyvaluep, YYLTYPE const * const yylocationp, CfgLexer *lexer, CfgArgs **result)
#else
static void
...
`------------------------------------------------*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yy_reduce_print (YYSTYPE *yyvsp, YYLTYPE *yylsp, int yyrule, CfgLexer *lexer, CfgArgs **result)
#else
static void
...
/*ARGSUSED*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yydestruct (const char *yymsg, int yytype, YYSTYPE *yyvaluep, YYLTYPE *yylocationp, CfgLexer *lexer, CfgArgs **result)
#else
static void
...
#else /* ! YYPARSE_PARAM */
#if defined __STDC__ || defined __cplusplus
int yyparse (CfgLexer *lexer, CfgArgs **result);
#else
int yyparse ();
#endif
#endif /* ! YYPARSE_PARAM */
...
yyparse (YYPARSE_PARAM)
    void *YYPARSE_PARAM;
     ...
     || defined __cplusplus || defined _MSC_VER)
int
yyparse (CfgLexer *lexer, CfgArgs **result)
#else
int
...
/* Line 1455 of yacc.c  */
#line 292 "block-ref-grammar.y"
    { cfg_args_set(*result, (yyvsp[(1) - (4)].cptr), (yyvsp[(3) - (4)].cptr)); free((yyvsp[(1) - (4)].cptr)); free((yyvsp[(3) - (4)].cptr)); }
    break;

  case 9:

/* Line 1455 of yacc.c  */
#line 313 "block-ref-grammar.y"
