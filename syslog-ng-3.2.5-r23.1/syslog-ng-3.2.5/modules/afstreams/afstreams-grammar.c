...
/* Line 171 of yacc.c  */
#line 78 "afstreams-grammar.c"
/* Substitute the variable and function names.  */
#define yyparse         afstreams_parse
#define yylex           afstreams_lex
#define yyerror         afstreams_error
#define yylval          afstreams_lval
#define yychar          afstreams_char
#define yydebug         afstreams_debug
#define yynerrs         afstreams_nerrs
#define yylloc          afstreams_lloc

/* Copy the first part of user declarations.  */


/* Line 189 of yacc.c  */
#line 93 "afstreams-grammar.c"
...
#define KW_DOOR 10020
#define KW_SUN_STREAMS 10021
...
/* Line 264 of yacc.c  */
#line 399 "afstreams-grammar.c"
/* Unqualified %code blocks.  */

/* Line 265 of yacc.c  */
#line 30 "afstreams-grammar.y"
...
{
     130,     0,    -1,     5,   131,    -1,   113,    -1,   126,   127,
     132,   128,    -1,   114,    -1,    -1,   136,   133,   134,    -1,
     135,   134,    -1,    -1,   113,    -1,   125,   127,   136,   128,
      -1,   114,    -1,   116,    -1,   119,    -1
};
...
{
       0,   297,   297,   302,   305,   306,   313,   312,   323,   324,
     328,   331,   332,   340,   341
};
#endif
...
static const char *const yytname[] =
{
  ...
  "LL_TOKEN", "LL_BLOCK", "LL_PRAGMA", "LL_EOL", "LL_ERROR", "KW_DOOR",
  "KW_SUN_STREAMS", "'('", "')'", "$accept", "start", "source_afstreams",
  "source_afstreams_params", "$@1", "source_afstreams_options",
  "source_afstreams_option", "string", 0
};
#endif
...
static const yytype_uint16 yytoknum[] =
{
   ...
   10425, 10426, 10427, 10428, 10429, 10020, 10021,    40,    41
};
# endif
...
{
       0,     0,     0,     3,     5,     0,     2,     1,     0,    13,
      14,     0,     6,     4,     9,    10,    12,     0,     7,     9,
       0,     8,     0,    11
};
...
{
       0,  -113,     6,  -120,  -120,  -119,  -120,  -120,  -112,  -120,
    -120,  -118,  -120,  -120,  -111,  -120,  -120,  -116,  -120,  -111,
    -112,  -120,  -110,  -120
};
...
{
       3,     4,    15,    16,     9,     1,     7,    10,     8,    21,
      13,    20,    22,     5,    17,     0,     0,     0,    23
};

static const yytype_int16 yycheck[] =
{
     113,   114,   113,   114,   116,     5,     0,   119,   127,    19,
     128,   127,    20,   126,   125,    -1,    -1,    -1,   128
};
...
{
       0,     5,   130,   113,   114,   126,   131,     0,   127,   116,
     119,   132,   136,   128,   133,   113,   114,   125,   134,   135,
     127,   134,   136,   128
};
