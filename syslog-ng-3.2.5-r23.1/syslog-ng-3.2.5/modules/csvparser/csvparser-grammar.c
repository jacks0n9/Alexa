...
/* Line 171 of yacc.c  */
#line 78 "csvparser-grammar.c"
/* Substitute the variable and function names.  */
#define yyparse         csvparser_parse
#define yylex           csvparser_lex
#define yyerror         csvparser_error
#define yylval          csvparser_lval
#define yychar          csvparser_char
#define yydebug         csvparser_debug
#define yynerrs         csvparser_nerrs
#define yylloc          csvparser_lloc

/* Copy the first part of user declarations.  */


/* Line 189 of yacc.c  */
#line 93 "csvparser-grammar.c"
...
/* Line 264 of yacc.c  */
#line 397 "csvparser-grammar.c"
/* Unqualified %code blocks.  */

/* Line 265 of yacc.c  */
#line 30 "csvparser-grammar.y"
...
{
       0,     0,     3,     6,     7,    13,    15,    20,    25,    28,
      29,    31,    36,    41,    46,    51,    56,    59,    60,    62,
      64,    66,    69
};
...
{
     129,     0,    -1,     6,   130,    -1,    -1,   125,   126,   131,
     134,   127,    -1,   133,    -1,    28,   126,   138,   127,    -1,
      94,   126,   137,   127,    -1,   135,   134,    -1,    -1,   132,
      -1,    75,   126,   136,   127,    -1,    37,   126,   137,   127,
      -1,    38,   126,   137,   127,    -1,    39,   126,   137,   127,
      -1,    40,   126,   137,   127,    -1,   137,   136,    -1,    -1,
     116,    -1,   119,    -1,   139,    -1,   137,   139,    -1,    -1
};

/* YYRLINE[YYN] -- source line where rule number YYN was defined.  */
static const yytype_uint16 yyrline[] =
{
       0,   296,   296,   302,   301,   310,   311,   315,   327,   328,
     332,   333,   334,   335,   336,   337,   341,   342,   347,   348,
     369,   373,   374
};
#endif
...
static const char *const yytname[] =
{
  ...
  "KW_CSV_PARSER", "'('", "')'", "$accept", "start", "parser_expr_csv",
  "$@1", "parser_column_opt", "parser_opt", "parser_csv_opts",
  "parser_csv_opt", "parser_csv_flags", "string", "string_list",
  "string_list_build", 0
};
#endif
...
{
       0,   128,   129,   131,   130,   132,   132,   133,   134,   134,
...
{
       0,     0,     0,     0,     2,     1,     3,     9,     0,     0,
       0,     0,     0,     0,     0,    10,     5,     0,     9,    22,
       0,     0,     0,     0,    17,     0,     4,     8,    18,    19,
      22,     0,    20,     0,     0,     0,     0,     0,    17,     0,
      21,     6,    12,    13,    14,    15,    11,    16,     7
};

/* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
      -1,     2,     4,     7,    15,    16,    17,    18,    37,    30,
      31,    32
};
...
{
       1,  -117,    14,  -111,  -118,  -118,  -118,   -28,  -109,  -108,
    -106,  -105,  -104,  -102,  -101,  -118,  -118,  -100,   -28,  -103,
    -103,  -103,  -103,  -103,  -103,  -103,  -118,  -118,  -118,  -118,
    -103,   -99,  -118,   -98,   -97,   -96,   -95,   -94,  -103,   -93,
...
{
    -118,  -118,  -118,  -118,  -118,  -118,     5,  -118,   -12,   -19,
    -118,     6
};
...
{
       8,    33,    34,    35,    36,    38,    39,     1,     3,     9,
      10,    11,    12,    28,     5,     6,    29,    19,    20,    38,
      21,    22,    23,    27,    24,    25,    47,    26,    41,    42,
      43,    44,    45,    46,    48,     0,    40,     0,     0,     0,
...
{
      28,    20,    21,    22,    23,    24,    25,     6,   125,    37,
      38,    39,    40,   116,     0,   126,   119,   126,   126,    38,
     126,   126,   126,    18,   126,   126,    38,   127,   127,   127,
     127,   127,   127,   127,   127,    -1,    30,    -1,    -1,    -1,
...
{
       0,     6,   129,   125,   130,     0,   126,   131,    28,    37,
      38,    39,    40,    75,    94,   132,   133,   134,   135,   126,
     126,   126,   126,   126,   126,   126,   127,   134,   116,   119,
     137,   138,   139,   137,   137,   137,   137,   136,   137,   137,
     139,   127,   127,   127,   127,   127,   127,   136,   127
};
...
do								\
  if (yychar == YYEMPTY && yylen == 1)				\
    ...
    {								\
      yyerror (&yylloc, lexer, last_parser, YY_("syntax error: cannot back up")); \
      YYERROR;							\
    }								\
while (YYID (0))
  ...
  if (yydebug)								  \
    {									  \
      ...
      yy_symbol_print (stderr,						  \
		  Type, Value, Location, lexer, last_parser); \
      YYFPRINTF (stderr, "\n");						  \
    }									  \
} while (YYID (0))
...
/*ARGSUSED*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yy_symbol_value_print (FILE *yyoutput, int yytype, YYSTYPE const * const yyvaluep, YYLTYPE const * const yylocationp, CfgLexer *lexer, LogParser **last_parser)
#else
static void
yy_symbol_value_print (yyoutput, yytype, yyvaluep, yylocationp, lexer, last_parser)
    FILE *yyoutput;
    int yytype;
...
`--------------------------------*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yy_symbol_print (FILE *yyoutput, int yytype, YYSTYPE const * const yyvaluep, YYLTYPE const * const yylocationp, CfgLexer *lexer, LogParser **last_parser)
#else
static void
yy_symbol_print (yyoutput, yytype, yyvaluep, yylocationp, lexer, last_parser)
    FILE *yyoutput;
    int yytype;
    YYSTYPE const * const yyvaluep;
    YYLTYPE const * const yylocationp;
...
`------------------------------------------------*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yy_reduce_print (YYSTYPE *yyvsp, YYLTYPE *yylsp, int yyrule, CfgLexer *lexer, LogParser **last_parser)
#else
static void
yy_reduce_print (yyvsp, yylsp, yyrule, lexer, last_parser)
    YYSTYPE *yyvsp;
    YYLTYPE *yylsp;
    int yyrule;
    CfgLexer *lexer;
  ...
  for (yyi = 0; yyi < yynrhs; yyi++)
    {
      ...
      yy_symbol_print (stderr, yyrhs[yyprhs[yyrule] + yyi],
		       &(yyvsp[(yyi + 1) - (yynrhs)])
		       , &(yylsp[(yyi + 1) - (yynrhs)])		       , lexer, last_parser);
      YYFPRINTF (stderr, "\n");
    }
}
...
do {					\
  if (yydebug)				\
    yy_reduce_print (yyvsp, yylsp, Rule, lexer, last_parser); \
} while (YYID (0))
...
/*ARGSUSED*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yydestruct (const char *yymsg, int yytype, YYSTYPE *yyvaluep, YYLTYPE *yylocationp, CfgLexer *lexer, LogParser **last_parser)
#else
static void
yydestruct (yymsg, yytype, yyvaluep, yylocationp, lexer, last_parser)
    const char *yymsg;
    int yytype;
    YYSTYPE *yyvaluep;
    YYLTYPE *yylocationp;
...
#else /* ! YYPARSE_PARAM */
#if defined __STDC__ || defined __cplusplus
int yyparse (CfgLexer *lexer, LogParser **last_parser);
#else
int yyparse ();
#endif
#endif /* ! YYPARSE_PARAM */
...
yyparse (YYPARSE_PARAM)
    void *YYPARSE_PARAM;
     ...
     || defined __cplusplus || defined _MSC_VER)
int
yyparse (CfgLexer *lexer, LogParser **last_parser)
#else
int
yyparse (lexer, last_parser)
    CfgLexer *lexer;
    LogParser **last_parser;
#endif
#endif
...
/* Line 1455 of yacc.c  */
#line 315 "csvparser-grammar.y"
    {
                                                  LogTemplate *template = cfg_check_inline_template(configuration, (yyvsp[(3) - (4)].cptr));
                                                  GError *error = NULL;

                                                  CHECK_ERROR(log_template_compile(template, &error), (yylsp[(3) - (4)]), "Error compiling template (%s)", error->message);
  ...
  if (!yyerrstatus)
    {
      ++yynerrs;
#if ! YYERROR_VERBOSE
      yyerror (&yylloc, lexer, last_parser, YY_("syntax error"));
#else
      {
	...
	if (0 < yysize && yysize <= yymsg_alloc)
	  {
	    ...
	    yyerror (&yylloc, lexer, last_parser, yymsg);
	  }
	else
	  {
	    yyerror (&yylloc, lexer, last_parser, YY_("syntax error"));
  ...
  if (yyerrstatus == 3)
      ...
      else
	{
	  yydestruct ("Error: discarding",
		      yytoken, &yylval, &yylloc, lexer, last_parser);
	  yychar = YYEMPTY;
	}
    }
  ...
  for (;;)
	...
	YYABORT;
      ...
      yydestruct ("Error: popping",
		  yystos[yystate], yyvsp, yylsp, lexer, last_parser);
      YYPOPSTACK (1);
      yystate = *yyssp;
      YY_STACK_PRINT (yyss, yyssp);
    }
...
`-------------------------------------------------*/
yyexhaustedlab:
  yyerror (&yylloc, lexer, last_parser, YY_("memory exhausted"));
  yyresult = 2;
  /* Fall through.  */
#endif
  ...
  while (yyssp != yyss)
    {
      yydestruct ("Cleanup: popping",
		  yystos[*yyssp], yyvsp, yylsp, lexer, last_parser);
      YYPOPSTACK (1);
    }
#ifndef yyoverflow
  if (yyss != yyssa)
