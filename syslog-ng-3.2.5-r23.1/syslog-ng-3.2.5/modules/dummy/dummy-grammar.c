...
#define yyparse         dummy_parse
#define yylex           dummy_lex
#define yyerror         dummy_error
#define yylval          dummy_lval
#define yychar          dummy_char
#define yydebug         dummy_debug
#define yynerrs         dummy_nerrs
#define yylloc          dummy_lloc

/* Copy the first part of user declarations.  */


/* Line 189 of yacc.c  */
#line 81 "dummy-grammar.c"
...
#define KW_DUMMY 10431
#define KW_DUMMY_OPT 10432
...
/* Line 264 of yacc.c  */
#line 400 "dummy-grammar.c"
/* Unqualified %code blocks.  */

/* Line 265 of yacc.c  */
#line 30 "dummy-grammar.y"
...
{
       0,     0,     3,     4,    11,    14,    15,    20,    22,    24
};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int16 yyrhs[] =
{
     130,     0,    -1,    -1,     4,   125,   131,   127,   132,   128,
      -1,   133,   132,    -1,    -1,   126,   127,   134,   128,    -1,
     111,    -1,   112,    -1,   117,    -1
};
...
{
       0,   288,   288,   287,   295,   296,   300,   311,   312,   313
};
#endif
...
static const char *const yytname[] =
{
  ...
  "LL_TOKEN", "LL_BLOCK", "LL_PRAGMA", "LL_EOL", "LL_ERROR", "KW_DUMMY",
  "KW_DUMMY_OPT", "'('", "')'", "$accept", "start", "$@1", "dummy_options",
  "dummy_option", "yesno", 0
};
#endif
...
static const yytype_uint16 yytoknum[] =
{
   ...
   10425, 10426, 10427, 10428, 10429, 10431, 10432,    40,    41
};
# endif
...
{
       0,   129,   131,   130,   132,   132,   133,   134,   134,   134
};
...
{
      -2,  -122,     4,  -123,  -123,  -120,  -121,  -119,  -118,  -121,
    -111,  -123,  -123,  -123,  -123,  -123,  -117,  -123
};

/* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] =
{
    -123,  -123,  -123,     0,  -123,  -123
};
...
{
      13,    14,     1,     3,     4,     7,    15,     6,    10,    12,
      11,    17
};

static const yytype_uint8 yycheck[] =
{
     111,   112,     4,   125,     0,   126,   117,   127,   127,     9,
     128,   128
};
...
{
       0,     4,   130,   125,     0,   131,   127,   126,   132,   133,
     127,   128,   132,   111,   112,   117,   134,   128
};
...
do								\
  if (yychar == YYEMPTY && yylen == 1)				\
    ...
    {								\
      yyerror (&yylloc, lexer, dummy_dd_instance, YY_("syntax error: cannot back up")); \
      YYERROR;							\
    }								\
while (YYID (0))
  ...
  if (yydebug)								  \
    {									  \
      ...
      yy_symbol_print (stderr,						  \
		  Type, Value, Location, lexer, dummy_dd_instance); \
      YYFPRINTF (stderr, "\n");						  \
    }									  \
} while (YYID (0))
...
/*ARGSUSED*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yy_symbol_value_print (FILE *yyoutput, int yytype, YYSTYPE const * const yyvaluep, YYLTYPE const * const yylocationp, CfgLexer *lexer, DummyDestDriver **dummy_dd_instance)
#else
static void
yy_symbol_value_print (yyoutput, yytype, yyvaluep, yylocationp, lexer, dummy_dd_instance)
    FILE *yyoutput;
    int yytype;
    YYSTYPE const * const yyvaluep;
    YYLTYPE const * const yylocationp;
    CfgLexer *lexer;
    DummyDestDriver **dummy_dd_instance;
#endif
{
  if (!yyvaluep)
    return;
...
`--------------------------------*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yy_symbol_print (FILE *yyoutput, int yytype, YYSTYPE const * const yyvaluep, YYLTYPE const * const yylocationp, CfgLexer *lexer, DummyDestDriver **dummy_dd_instance)
#else
static void
yy_symbol_print (yyoutput, yytype, yyvaluep, yylocationp, lexer, dummy_dd_instance)
    FILE *yyoutput;
    int yytype;
    YYSTYPE const * const yyvaluep;
    YYLTYPE const * const yylocationp;
...
`------------------------------------------------*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yy_reduce_print (YYSTYPE *yyvsp, YYLTYPE *yylsp, int yyrule, CfgLexer *lexer, DummyDestDriver **dummy_dd_instance)
#else
static void
yy_reduce_print (yyvsp, yylsp, yyrule, lexer, dummy_dd_instance)
    YYSTYPE *yyvsp;
    YYLTYPE *yylsp;
    int yyrule;
    CfgLexer *lexer;
  ...
  for (yyi = 0; yyi < yynrhs; yyi++)
    {
      ...
      yy_symbol_print (stderr, yyrhs[yyprhs[yyrule] + yyi],
		       &(yyvsp[(yyi + 1) - (yynrhs)])
		       , &(yylsp[(yyi + 1) - (yynrhs)])		       , lexer, dummy_dd_instance);
      YYFPRINTF (stderr, "\n");
    }
}
...
do {					\
  if (yydebug)				\
    yy_reduce_print (yyvsp, yylsp, Rule, lexer, dummy_dd_instance); \
} while (YYID (0))
...
/*ARGSUSED*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yydestruct (const char *yymsg, int yytype, YYSTYPE *yyvaluep, YYLTYPE *yylocationp, CfgLexer *lexer, DummyDestDriver **dummy_dd_instance)
#else
static void
yydestruct (yymsg, yytype, yyvaluep, yylocationp, lexer, dummy_dd_instance)
    const char *yymsg;
    int yytype;
    YYSTYPE *yyvaluep;
    YYLTYPE *yylocationp;
...
#else /* ! YYPARSE_PARAM */
#if defined __STDC__ || defined __cplusplus
int yyparse (CfgLexer *lexer, DummyDestDriver **dummy_dd_instance);
#else
int yyparse ();
#endif
#endif /* ! YYPARSE_PARAM */
...
yyparse (YYPARSE_PARAM)
    void *YYPARSE_PARAM;
     ...
     || defined __cplusplus || defined _MSC_VER)
int
yyparse (CfgLexer *lexer, DummyDestDriver **dummy_dd_instance)
#else
int
yyparse (lexer, dummy_dd_instance)
    CfgLexer *lexer;
    DummyDestDriver **dummy_dd_instance;
#endif
#endif
...
/* Line 1455 of yacc.c  */
#line 300 "dummy-grammar.y"
    { (*dummy_dd_instance)->opt = (yyvsp[(3) - (4)].num); }
    break;

  case 7:

/* Line 1455 of yacc.c  */
#line 311 "dummy-grammar.y"
    { (yyval.num) = 1; }
    break;
  ...
  if (!yyerrstatus)
    {
      ++yynerrs;
#if ! YYERROR_VERBOSE
      yyerror (&yylloc, lexer, dummy_dd_instance, YY_("syntax error"));
#else
      {
	...
	if (0 < yysize && yysize <= yymsg_alloc)
	  {
	    ...
	    yyerror (&yylloc, lexer, dummy_dd_instance, yymsg);
	  }
	else
	  {
	    yyerror (&yylloc, lexer, dummy_dd_instance, YY_("syntax error"));
  ...
  if (yyerrstatus == 3)
      ...
      else
	{
	  yydestruct ("Error: discarding",
		      yytoken, &yylval, &yylloc, lexer, dummy_dd_instance);
	  yychar = YYEMPTY;
	}
    }
  ...
  for (;;)
	...
	YYABORT;
      ...
      yydestruct ("Error: popping",
		  yystos[yystate], yyvsp, yylsp, lexer, dummy_dd_instance);
      YYPOPSTACK (1);
      yystate = *yyssp;
      YY_STACK_PRINT (yyss, yyssp);
    }
...
`-------------------------------------------------*/
yyexhaustedlab:
  yyerror (&yylloc, lexer, dummy_dd_instance, YY_("memory exhausted"));
  yyresult = 2;
  /* Fall through.  */
#endif
  ...
  while (yyssp != yyss)
    {
      yydestruct ("Cleanup: popping",
		  yystos[*yyssp], yyvsp, yylsp, lexer, dummy_dd_instance);
      YYPOPSTACK (1);
    }
#ifndef yyoverflow
  if (yyss != yyssa)
