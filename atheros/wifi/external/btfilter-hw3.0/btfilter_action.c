...
static const BT_CONTROL_ACTION_DESC_STATE g_ActionDefaults[ATH_BT_MAX_STATE_INDICATION] =
{
    ...
    /* ATH_BT_PAGESCAN*/      {{{ "-pPSCAN 10 2 0 0",  0, NULL }, { "-pPSCAN 10 1 2048 18",  0, NULL }}},
};
...
static const BT_CONTROL_ACTION_DESC_STATE g_ActionDefaultsMcKinley[ATH_BT_MAX_STATE_INDICATION] =
{
    ...
    /* ATH_BT_HID     */      {{{ "-s 5 2 0",             0, NULL }, { "-pHID 0 0 0 30 ; -s 5 1 0",0, NULL }}},
    /* ATH_BT_PAGESCAN*/      {{{ "-pPSCAN 10 1 0 0",  0, NULL }, { "-pPSCAN 10 2 2048 18",  0, NULL }}},
};
        ...
        case BT_PARAM_PAGESCAN_TAG:
            {
                ...
                pOperatingStatus->btProfileType = (A_UINT32)args[0];
                pOperatingStatus->btOperatingStatus =(A_UINT32)args[1];
                pOperatingStatus->btLinkId = (((A_UINT32)args[2]) << 16) | ((A_UINT32)args[3]);
            }
        default:
            break;
