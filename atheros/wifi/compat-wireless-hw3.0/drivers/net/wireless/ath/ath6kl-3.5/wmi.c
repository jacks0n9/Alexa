			      ...
			      u16 maxact_scan_per_ssid)
{
	...
	if (first_scan) {
		first_scan = 0;
		sc->maxact_chdwell_time = cpu_to_le16(100);
		sc->pas_chdwell_time = cpu_to_le16(100);
		sc->maxact_scan_per_ssid = cpu_to_le16(1);
	}
