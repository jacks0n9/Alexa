...
typedef ssize_t (*btd_adapter_pin_cb_t) (struct btd_adapter *adapter,
			struct btd_device *dev, char *out, ssize_t len, gboolean *display);
void btd_adapter_register_pin_cb(struct btd_adapter *adapter,
						btd_adapter_pin_cb_t cb);
void btd_adapter_unregister_pin_cb(struct btd_adapter *adapter,
						btd_adapter_pin_cb_t cb);
ssize_t speaker_pin_create_request_cb(struct btd_adapter *, struct btd_device *device,
                                        char *pinbuf, ssize_t pin_len, gboolean *display);
...
struct btd_adapter_ops {
	...
	int (*read_voice_setting) (int index, uint16_t *vs);
	int (*write_voice_setting) (int index, uint16_t vs);
};
