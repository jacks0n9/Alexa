...
#define SDRC_EMR_0		(OMAP34XX_SDRC_BASE+0x8C)
#define SDRC_EMR_1		(OMAP34XX_SDRC_BASE+0xBC)
...
#define WD_LOCK1		0xBBBB
#define WD_LOCK2		0x4444

/* SCM */
#define SCM_BASE		0x48002000
#define SCM_SCRATCHPAD_OFFSET		0x910
/* 32 khz Timer */
#define TIMER_32KSYN_BASE    0x48320000
#define TIMER_32KSYNTIMER_CR  (TIMER_32KSYN_BASE + 0x10)
