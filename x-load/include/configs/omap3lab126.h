/*
 * Copyright (C) 2011 Texas Intruments.
 *
...
#define CONFIG_OMAP3LAB126       1    /* working with LAB126 Board */
...
// Max size of u-boot in nand (page boundary)
#define CONFIG_UBOOT_MAX_SIZE		(280 * 1024) /* 280-KB */
#define CONFIG_WATCHDOG_TIMEOUT_SEC		5
#define CONFIG_CUSTOM_PARTITION		1
/*-----------------------------------------------------------------------
 * Stack sizes
 *
...
#define NAND_16BIT
#ifndef FOUR_BIT_ERROR_CORRECT
#define FOUR_BIT_ERROR_CORRECT /* ECC_HW_ENABLE */
#endif

/* NAND is partitioned:
 * 0x00000000 - 0x0007FFFF  Booting Image
 * 0x00080000 - 0x0013FFFF  U-Boot Image - Main
 * 0x00140000 - 0x0019FFFF  U-Boot Image - Recovery
 * 0x00200000 - 0x0027FFFF  Data-MFG
*/
#define NAND_MAIN_UBOOT_START		0x0080000 /* Leaving first 4 blocks for x-load */
#define NAND_MAIN_UBOOT_END		0x0140000
#define NAND_REC_UBOOT_START		0x0140000
#define NAND_REC_UBOOT_END		0x0200000 /* 12 blocks = 1536KB for main & recovery u-boot */
