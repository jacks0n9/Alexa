 ...
 *	ftp://www.micrel.com/ethernet/ks8851
  ...
  PCD     07/26/07  0.0.1    Register definition base on KS8851 datasheet.
  -----------------------------------------------------------------------------------------
 */
...
#define   QMU_RW_BY_1BYTE             0x0080    /* Using 'register access' cmd to access QMU by 1-byte burst */
#define   QMU_RW_BY_2BYTE             0x0040    /* Using 'register access' cmd to access QMU by 2-byte burst */
#define   EEPROM_DATA_WRITE           0x0020    /* 0 set EDD pad tri-state during read and set to 1 during write. */
...
#define   DEFAULT_TX_CTRL             ( TX_CTRL_UDP_CHECKSUM | \
...
#define   UNICAST_RX_CTRL1            (RX_CTRL_UDP_CHECKSUM | RX_CTRL_TCP_CHECKSUM | \
                                       RX_CTRL_IP_CHECKSUM  | RX_CTRL_MAC_FILTER   | \
                                       RX_CTRL_FLOW_ENABLE  | \
                                       RX_CTRL_ALL_MULTICAST| RX_CTRL_UNICAST )

#define   PROMISC_RX_CTRL1            (RX_CTRL_UDP_CHECKSUM | RX_CTRL_TCP_CHECKSUM | \
                                       RX_CTRL_IP_CHECKSUM  | RX_CTRL_PROMISCUOUS  | \
                                       RX_CTRL_FLOW_ENABLE  | RX_CTRL_BROADCAST    | \
                                       RX_CTRL_ALL_MULTICAST| RX_CTRL_UNICAST      | \
									   RX_CTRL_INVERSE_FILTER )

#define   ALLMULTI_RX_CTRL1           (RX_CTRL_UDP_CHECKSUM | RX_CTRL_TCP_CHECKSUM | \
                                       RX_CTRL_IP_CHECKSUM  | RX_CTRL_MAC_FILTER   | \
                                       RX_CTRL_FLOW_ENABLE  | RX_CTRL_BROADCAST    | \
                                       RX_CTRL_ALL_MULTICAST| RX_CTRL_UNICAST      | \
									   RX_CTRL_MULTICAST    | RX_CTRL_PROMISCUOUS  )

#define REG_RX_CTRL2               0x76       /* RXCR2 */
#define   RX_SPI_BURST_FRAME          0x0080    /* SPI Receive data burst length - single frame */
#define   RX_SPI_BURST_32             0x0060    /* SPI Receive data burst length - 32-byte */
#define   RX_SPI_BURST_16             0x0040    /* SPI Receive data burst length - 16-byte */
#define   RX_SPI_BURST_8              0x0020    /* SPI Receive data burst length - 8-byte */
#define   RX_SPI_BURST_4              0x0000    /* SPI Receive data burst length - 4-byte */
...
#endif
#if (0)
#define   RXQ_CMD_CNTL                (RXQ_FRAME_CNT_INT|RXQ_TWOBYTE_OFFSET)
#endif
...
#define   INT_TX_ETH                  0x4000    /* Enable transmit done interrupt */
#define   INT_RX_ETH                  0x2000    /* Enable receive interrupt */
#define   INT_RX_OVERRUN_ETH          0x0800    /* Enable receive overrun interrupt */
#define   INT_TX_STOPPED_ETH          0x0200    /* Enable transmit process stopped interrupt */
#define   INT_RX_STOPPED_ETH          0x0100    /* Enable receive process stopped interrupt */
...
#define   INT_MASK                    ( INT_RX | INT_PHY )
